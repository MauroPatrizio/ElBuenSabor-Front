		...
		<div>
			<div className={style.containerEmpresaSucursal}>
				<div className={style.containerEmpresa}>
					...
					<div className={style.listEmpresas}>
						{datosGuardados.length > 0 ? (
							datosGuardados.map((dato) => <CardEmpresa key={dato.cuit} dato={dato} handleVerEmpresa={handleVerEmpresa} handleEditarEmpresa={handleEditarEmpresa} />)
						) : (
							<div>
				...
				<div className={style["div-container-sucursal"]}>
					...
					<div>
						<ModalSucursal handleOpen={open} handleClose={handleClose} onAddSucursal={handleAddSucursal} isEdit={false} />
					</div>
					<div>
			...
			<ModalEmpresa mostrarPopUp={mostrarPopUp} formData={formData} modoEdicion={modoEdicion} empresaSeleccionada={empresaSeleccionada} manejarCambio={manejarCambio} manejarSubmit={manejarSubmit} handleClosePopUp={handleClosePopUp} />
		</div>
	);
};
